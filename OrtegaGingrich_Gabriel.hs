...
{-
This homework consits of the implementation of operators and expression trees
...
In particular do not elminate any of the comments and most importantly DO NOT make any change the code of the test functions. 
Points will be taken away for tampering with those functions.

Dont forget to define the type for all the functions you code!!!
-}
